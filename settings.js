...
global.botname = "Sadiq Bot" 
global.botLanguage = "default" // 𝗗𝗲𝗳𝗮𝘂𝗹𝘁 || 𝗘𝗻𝗴𝗹𝗶𝘀𝗵 || 𝗛𝗶𝗻𝗱𝗶 || 𝗔𝗿𝗮𝗯𝗶𝗰 \\
global.author = "𝐒𝐀𝐃𝐈𝐐"  
global.packname = "𝙼𝚒𝚜𝚊 𝙰𝚖𝚊𝚗𝚎"  
global.myweb = "https://t.me/UL7R0N" // You can put any link 
global.waterMark = "×͜× King ✘ SadiQ™ ✓" // Your own watermark 
global.headerText = "Sadiq by Misa" // text for header of menu         
global.DocumentTitle = "MASTER⚔️SADIQ" 


global.ownername = "𝐒𝐀𝐃𝐈𝐐❤️"   // Owner name //        
global.ownernumber = ['919506756846'] 
global.socialm = "𝗜𝗻𝘀𝘁𝗮 : simpsadiq" // 𝗜𝗻𝘀𝘁𝗮 : || 𝗚𝗶𝘁𝗵𝘂𝗯 : || 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : \\
global.ytname = "Faith: كُلُّ نَفْسٍ ذَاۤىِٕقَةُ الْمَوْتِۗ"   // Yt chanel name //
global.continent = "Asia" // your continent name 
global.region = "India" // your country name
global.state = "UttarPradesh" // your state name
global.district = "NahiBataunga" // your district name
global.timezone = "Asia/Kolkata" // search on google if you don't know the timezone of your country //
global.instagramId = "simpsadiq" // Your insta ID
global.email = "simpsadiq@gmail.com" // put your email here
...
footer1 = `𓄂⍣⃝𝑺𝜶𝜹𝒊𝝋 𝜷𝜽𝝉ㅤꪜ⃢𝟤ㅤ𓆩×͜×𓆪ꪾ`
footer2 = `𓄂⍣⃝𝑺𝜶𝜹𝒊𝝋 𝜷𝜽𝝉ㅤꪜ⃢𝟤ㅤ𓆩×͜×𓆪ꪾ`
...
tag9 = '𝘠𝘰𝘶 𝘢𝘭𝘭 𝘴𝘩𝘰𝘶𝘭 𝘵𝘳𝘺 𝘵𝘩𝘪𝘴 𝘤𝘶𝘵𝘦 Misa❤️🍫' 
tag10 = '𝘈𝘺𝘰𝘰 Sadiq 𝘪𝘴 𝘉𝘦𝘴𝘵!!😚' 
